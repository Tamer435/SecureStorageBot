...
def convertStrToArray(string):
    '''
    Функция конвертирует строку в массив
    :param string: Объект типа str
    :return: Массив id сообщений/None
    '''
    try:
...
def convertArrayToStr(array):
    '''
    Функция конвертирует массив в строку
    :param array: Массив id сообщений
    :return: str
    '''
    string = str(array)
    return string
...
class CreateStorage(StatesGroup):
    '''
    Машина состояний, которая отвечает за процесс создания хранилища
    '''
    setPassword = State()
...
class OpenStorage(StatesGroup):
    '''
    Машина состояний, которая отвечает за процесс открытия хранилища
    '''
    getPassword = State()
...
class DeleteStorage(StatesGroup):
    '''
    Машина состояний, которая отвечает за процесс удаления хранилища
    '''
    getPermission = State()
...
class StorageMode(StatesGroup):
    '''
    Машина состояний, которая отвечает за режим хранилища
    '''
    modeStorage = State()
...
class ChangePassword(StatesGroup):
    '''
    Машина состояний, которая отвечает за процесс смены и установки пароля
    '''
...
async def start(message: types.message):
    """
    Функция отвечает за обработку всех поступающих сообщений, не попавших под фильтр машин состояний
    :param message: сообщение пользоввателя
    :return: None
    """
...
async def setPassword(message: types.message, state: CreateStorage):
    '''
